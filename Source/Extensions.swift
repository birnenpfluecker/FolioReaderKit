        ...
        if rgba.hasPrefix("#") {
            ...
            if scanner.scanHexInt64(&hexValue) {
                ...
                case 8:
                    ...
                    break
                default:
                    printLog("Invalid RGB string, number of characters after '#' should be either 3, 4, 6 or 8")
                    break
                }
            } else {
                printLog("Scan hex error")
            }
        } else {
            printLog("Invalid RGB string, missing '#' as prefix")
        }
