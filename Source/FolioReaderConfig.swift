...
public func frkLocalizedString(_ key: String, comment: String) -> String {
    return NSLocalizedString(key, tableName: "FolioReaderKit", bundle: Bundle.frameworkBundle(), comment: comment)
}
...
//    open var realmConfiguration = Realm.Configuration(schemaVersion: 2)
    ...
    open var localizedHighlightsTitle = frkLocalizedString("Highlights", comment: "")

    /// Localizes Content title
    open var localizedContentsTitle = frkLocalizedString("Contents", comment: "")
    ...
    open var localizedHighlightMenu = frkLocalizedString("Highlight", comment: "")
    open var localizedDefineMenu = frkLocalizedString("Define", comment: "")
    open var localizedPlayMenu = frkLocalizedString("Play", comment: "")
    open var localizedPauseMenu = frkLocalizedString("Pause", comment: "")
    open var localizedFontMenuNight = frkLocalizedString("Night", comment: "")
    open var localizedPlayerMenuStyle = frkLocalizedString("Style", comment: "")
    open var localizedFontMenuDay = frkLocalizedString("Day", comment: "")
    open var localizedLayoutHorizontal = frkLocalizedString("Horizontal", comment: "")
    open var localizedLayoutVertical = frkLocalizedString("Vertical", comment: "")
    open var localizedReaderOnePageLeft = frkLocalizedString("1 page left", comment: "")
    open var localizedReaderManyPagesLeft = frkLocalizedString("pages left", comment: "")
    open var localizedReaderManyMinutes = frkLocalizedString("minutes", comment: "")
    open var localizedReaderOneMinute = frkLocalizedString("1 minute", comment: "")
    open var localizedReaderLessThanOneMinute = frkLocalizedString("Less than a minute", comment: "")
    open var localizedShareWebLink: URL? = nil
    open var localizedShareChapterSubject = frkLocalizedString("Check out this chapter from", comment: "")
    open var localizedShareHighlightSubject = frkLocalizedString("Notes from", comment: "")
    open var localizedShareAllExcerptsFrom = frkLocalizedString("All excerpts from", comment: "")
    open var localizedShareBy = frkLocalizedString("by", comment: "")
    open var localizedCancel = frkLocalizedString("Cancel", comment: "")
    open var localizedShare = frkLocalizedString("Share", comment: "")
    open var localizedChooseExisting = frkLocalizedString("Choose existing", comment: "")
    open var localizedTakePhoto = frkLocalizedString("Take Photo", comment: "")
    open var localizedShareImageQuote = frkLocalizedString("Share image quote", comment: "")
    open var localizedShareTextQuote = frkLocalizedString("Share text quote", comment: "")
    open var localizedSave = frkLocalizedString("Save", comment: "")
    open var localizedHighlightNote = frkLocalizedString("Note", comment: "")
